...
export function ChatHeader({ onClose, onClear, messageCount }: ChatHeaderProps) {
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
      ...
      <div className="flex items-center space-x-2">
        <button
          onClick={onClear}
          className="p-2 hover:bg-background-hover rounded-lg transition-colors duration-200"
